...
export default async function GruppenUndAbteilungenSeite() {
  ...
  return (
    <main className="mx-auto max-w-5xl px-5 py-10">
      ...
      <h1 className="text-center text-2xl font-semibold text-marke-grau md:text-left">Gruppen &amp; Abteilungen</h1>

      <div className="mt-6 grid grid-cols-1 gap-8 md:grid-cols-2">
        <section>
          <h2 className="text-sm font-semibold text-neutral-600">Gruppen</h2>

          <form
            action={gruppeErstellen}
            className="mt-2 flex gap-2 rounded-xl border border-neutral-200 bg-white p-4"
          >
            <input
              name="name"
              type="text"
          ...
          <ul className="mt-3 flex flex-col divide-y divide-neutral-100 rounded-xl border border-neutral-200 bg-white">
            {gruppen.map((gruppe) => (
        ...
        <section>
          <h2 className="text-sm font-semibold text-neutral-600">Abteilungen</h2>
              ...
              <li key={abteilung.id} className="flex items-center gap-2 px-4 py-2.5">
                ...
                >
                  <input
                    ...
                    className={
                      "h-9 flex-1 rounded-lg border border-neutral-300 px-2 text-sm " +
                      (abteilung.aktiv ? "" : "text-neutral-400")
                    }
                  />
                  <input
                    name="kuerzel"
                    ...
                    maxLength={8}
                    className={
                      "h-9 w-24 shrink-0 rounded-lg border border-neutral-300 px-2 text-sm " +
                      (abteilung.aktiv ? "" : "text-neutral-400")
                    }
                  />
                  <button
